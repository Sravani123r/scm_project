...
const Home = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Banner Section */}
      <section className="bg-gray-600 text-white py-20 animate__animated animate__fadeInDown">
      ...
      {/* Contact Section */}
      <section className="py-20 bg-gray-100 animate__animated animate__fadeInUp">
        <div className="container mx-auto text-center px-4">
          <h2 className="text-3xl font-bold mb-12">Get in Touch</h2>

          <form className="max-w-lg mx-auto space-y-4">
            <Input type="text" label="Your Name" variant="bordered" placeholder="Enter your name" />
            <Input type="email" label="Your Email" variant="bordered" placeholder="Enter your email" />
            <Textarea label="Your Message" variant="bordered" placeholder="Write your message..." minRows={3} />
